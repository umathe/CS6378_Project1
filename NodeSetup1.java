...
//		ConfigInput_Parser main = new ConfigInput_Parser();
		...
		n1.nodeNumber = Integer.parseInt(info_nodes[1][0]);
		nodePortNumber = Integer.parseInt(info_nodes[1][2]);
		nodeHostName = info_nodes[1][1];
		nodeNeighbors = info_nodes[1][3];
		...
		Thread t2 = new Thread(new Runnable() {
			public void run() {
				delayInterval.schedule(taskClientDelay, 1000);
