...
//		ConfigInput_Parser main = new ConfigInput_Parser();
		...
		//NodeSetup n1 = new NodeSetup();
		n1.nodeNumber = Integer.parseInt(info_nodes[0][0]);
		nodePortNumber = Integer.parseInt(info_nodes[0][2]);
		nodeHostName = info_nodes[0][1];
		nodeNeighbors = info_nodes[0][3];
		...
		Thread t1 = new Thread(new Runnable() {
			public void run() {
				...
				n1.setServer(nodePortNumber1, info_nodes.length);
			}
		});
