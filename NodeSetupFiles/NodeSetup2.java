...
ServerSocket ssoc = null;
	...
	public static void main(String[] args) {
		...
		n1.nodeNumber = Integer.parseInt(info_nodes[2][0]);
		nodePortNumber = Integer.parseInt(info_nodes[2][2]);
		nodeHostName = info_nodes[2][1];
		nodeNeighbors = info_nodes[2][3];
